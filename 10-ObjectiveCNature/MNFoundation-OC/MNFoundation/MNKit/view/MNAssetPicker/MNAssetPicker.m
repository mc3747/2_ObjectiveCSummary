...
@interface MNAssetPicker ()<MNCameraControllerDelegate, MNAssetPickerDelegate,  MNImageCropDelegate,UIViewControllerTransitioningDelegate>
...
- (void)assetPickerDidCancel:(MNAssetPicker *)picker {
    ...
    [self dismissViewControllerAnimated:YES completion:^{
        if (weakself.cancelHandler) {
            weakself.cancelHandler(weakself);
        }
    }];
}
...
- (void)assetPicker:(MNAssetPicker *)picker didFinishPickingAssets:(NSArray<MNAsset *> *)assets {
    ...
    [self dismissViewControllerAnimated:YES completion:^{
        if (weakself.pickingHandler) {
            weakself.pickingHandler(weakself, assets);
        }
    }];
}
