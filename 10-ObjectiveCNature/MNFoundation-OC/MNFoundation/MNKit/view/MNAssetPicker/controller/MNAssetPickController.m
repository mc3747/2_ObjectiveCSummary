...
#import "MNAssetTouchController.h"
@interface MNAssetPickController ()<MNAssetCellDelegate, MNImageCropDelegate, MNAlbumViewDelegate, MNAssetToolDelegate, MNCameraControllerDelegate, MNAssetBrowseDelegate, MNAssetTouchDelegate, MNAssetPreviewDelegate, MNImageCropDelegate, UIViewControllerPreviewingDelegate, PHPhotoLibraryChangeObserver>
#else
@interface MNAssetPickController ()<MNAssetCellDelegate, MNImageCropDelegate, MNAlbumViewDelegate, MNAssetToolDelegate, MNCameraControllerDelegate, MNAssetBrowseDelegate, MNAssetTouchDelegate, MNAssetPreviewDelegate, MNImageCropDelegate, PHPhotoLibraryChangeObserver>
#endif
