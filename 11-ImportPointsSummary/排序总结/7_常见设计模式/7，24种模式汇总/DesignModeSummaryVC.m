...
#import "DesignModeSummaryVC.h"


@interface DesignModeSummaryVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DesignModeSummaryVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row < 5) {
        ...
        cell.textLabel.textColor = [self.color1 reverseColor];
    }else if(indexPath.row < 12){
        cell.backgroundColor = self.color2;
        cell.textLabel.textColor = [self.color2 reverseColor];
    }else{
        cell.backgroundColor = self.color3;
        cell.textLabel.textColor = [self.color3 reverseColor];
    }
