...
NSString *const MNURLRequestUploadBoundaryName = @"MNKitFormBoundaryName";
                                        ...
                                        error:(NSError *__autoreleasing *)error
{
    ...
    [request setValue:[NSString stringWithFormat:@"multipart/form-data; charset=utf-8;boundary=%@", MNURLRequestUploadBoundaryName] forHTTPHeaderField:@"Content-Type"];
    if (self.headerFields.count > 0) {
        [self.headerFields enumerateKeysAndObjectsUsingBlock:^(NSString * _Nonnull field, NSString * _Nonnull value, BOOL * _Nonnull stop) {
    ...
    if (self.queryStringSerializationCallback) {
        ...
        query = self.queryStringSerializationCallback(request, parameter, &serializationError);
        ...
        query = MNQueryStringFromParameters(parameter, @"&");
    }
