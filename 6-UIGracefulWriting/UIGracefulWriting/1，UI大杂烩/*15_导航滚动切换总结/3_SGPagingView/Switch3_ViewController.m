...
#import "Switch3_ViewController.h"
...
@interface Switch3_ViewController () <UITableViewDelegate, UITableViewDataSource>
@property (weak, nonatomic)  UITableView *tableView;
@property (nonatomic, strong) NSArray *TitleDataList;
@end

@implementation Switch3_ViewController
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        tableView.contentInset = UIEdgeInsetsMake(tabEY, 0, 0, 0);
