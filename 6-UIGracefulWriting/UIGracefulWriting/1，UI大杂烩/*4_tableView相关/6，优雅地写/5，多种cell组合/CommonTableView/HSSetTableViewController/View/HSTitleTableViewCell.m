...
@property (nonatomic, strong) HSTitleCellModel *titleCellModel;
@end
...
- (void)setupDataModel:(HSBaseCellModel *)model
{
    ...
    self.titleCellModel = cellMoldel;
...
- (void)layoutSubviews {
    ...
    if (self.titleCellModel.imageRect.size.width > 0) {
         self.imageView.frame = self.titleCellModel.imageRect;
    }
