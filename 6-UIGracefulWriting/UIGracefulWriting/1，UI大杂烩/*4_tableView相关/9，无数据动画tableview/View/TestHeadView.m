...
- (void)layoutSubviews {
    ...
    //布局
    titleLab.frame = CGRectMake(CGRectGetMaxX(headImg.frame)+10, 15, titleSize.width>0?titleSize.width:100, 50);
    contentLab.frame = CGRectMake(CGRectGetMaxX(headImg.frame)+10, 15+25+10, contentSize.width>0?contentSize.width:150, 25);
}
