...
- (void)layoutSubviews{
    ...
    _imageShow.frame = CGRectMake(10, 0, [UIScreen mainScreen].bounds.size.width/2-30, [UIScreen mainScreen].bounds.size.width/2-30);
    _labelShow.frame = CGRectMake(10, [UIScreen mainScreen].bounds.size.width/2-30, [UIScreen mainScreen].bounds.size.width/2-30, 15);
