...
- (void)initView{
    ...
    stretchyLayout.itemSize = CGSizeMake([UIScreen mainScreen].bounds.size.width, 40);
    stretchyLayout.headerReferenceSize = CGSizeMake([UIScreen mainScreen].bounds.size.width, 240);
    
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, self.navBarHeight, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height-self.navBarHeight) collectionViewLayout:stretchyLayout];
