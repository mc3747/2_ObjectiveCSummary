...
- (void)initView{
    ...
    tiltedLayout.itemSize = CGSizeMake([UIScreen mainScreen].bounds.size.width, 130);
    tiltedLayout.minimumLineSpacing = 15;
    
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, self.navBarHeight, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height-self.navBarHeight) collectionViewLayout:tiltedLayout];
