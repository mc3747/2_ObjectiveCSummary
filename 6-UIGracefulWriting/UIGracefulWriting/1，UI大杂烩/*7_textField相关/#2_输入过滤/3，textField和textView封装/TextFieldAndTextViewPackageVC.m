...
#import "TextFieldAndTextViewPackageVC.h"
...
@interface TextFieldAndTextViewPackageVC ()<ZLYTextFieldDelegate,ZLYTextViewDelegate>
...
@implementation TextFieldAndTextViewPackageVC
...
-(void)createTextField{
    ZLYTextField * textField = [[ZLYTextField alloc]initWithFrame:CGRectMake(10, 120, self.view.frame.size.width-20, 40)];
...
-(void)createTextView
{
    ZLYTextView * textView = [[ZLYTextView alloc]initWithFrame:CGRectMake(10, 180, self.view.frame.size.width-20, 150)];
