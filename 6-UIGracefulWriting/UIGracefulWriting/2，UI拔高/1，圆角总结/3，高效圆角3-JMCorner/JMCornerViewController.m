...
#import "JMCornerViewController2.h"
#import "TableViewCell.h"

@interface JMCornerViewController () <UITableViewDataSource>

@end

@implementation JMCornerViewController
...
- (void)rightBarButtonClick {
    JMCornerViewController2 *VC = [[JMCornerViewController2 alloc] init];
