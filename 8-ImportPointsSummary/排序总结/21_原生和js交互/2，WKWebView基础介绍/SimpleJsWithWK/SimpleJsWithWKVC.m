...
@interface SimpleJsWithWKVC ()<WKScriptMessageHandler>

@property (nonatomic, strong) WKWebView *webView;

@end

@implementation SimpleJsWithWKVC

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor limeColor];
    ...
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"SimpleJsWithWK" ofType:@"html"];
    NSURL *baseURL = [[NSBundle mainBundle] bundleURL];
    [self.webView loadHTMLString:[NSString stringWithContentsOfFile:filePath encoding:NSUTF8StringEncoding error:nil] baseURL:baseURL];
    self.webView.backgroundColor = [UIColor orangeRed];
