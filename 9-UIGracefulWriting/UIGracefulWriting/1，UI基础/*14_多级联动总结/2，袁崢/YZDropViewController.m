...
@interface YZDropViewController ()<YZPullDownMenuDataSource>
@property (nonatomic, strong) NSArray *titles;
@end

@implementation YZDropViewController
...
- (void)viewDidLoad {
    ...
    menu.frame = CGRectMake(0, 66, SCREEN_WIDTH, 44);
