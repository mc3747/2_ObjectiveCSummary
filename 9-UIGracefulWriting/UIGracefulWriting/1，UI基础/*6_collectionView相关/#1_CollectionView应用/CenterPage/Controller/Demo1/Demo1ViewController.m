...
- (void)initView{
    ...
    flowLayout.itemSize = CGSizeMake([UIScreen mainScreen].bounds.size.width/2-10, [UIScreen mainScreen].bounds.size.width/2-10);
    flowLayout.scrollDirection = UICollectionViewScrollDirectionVertical;
    flowLayout.minimumLineSpacing = 20;//设置每个item之间的间距
    
    UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, self.navBarHeight, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height-self.navBarHeight) collectionViewLayout:flowLayout];
