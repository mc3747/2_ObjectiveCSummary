...
- (void)initView{
    ...
    UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, self.navBarHeight, [UIScreen mainScreen].bounds.size.width, 200) collectionViewLayout:flowLayout];
    ...
    pageControl.center = CGPointMake([UIScreen mainScreen].bounds.size.width*0.5, 160+self.navBarHeight);
