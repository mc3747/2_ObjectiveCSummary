...
- (void)lm_addCorner:(CGFloat)radius{
    [self lm_addCorner:radius borderWidth:1 borderColor:[UIColor blackColor] backGroundColor:[UIColor clearColor]];
}
...
- (void)lm_addCorner:(CGFloat)radius
    ...
    UIImageView *imageView = [[UIImageView alloc]initWithImage:[self lm_drawRectWithRoundedCorner:radius borderWidth:borderWidth borderColor:borderColor backGroundColor:bgColor]];
