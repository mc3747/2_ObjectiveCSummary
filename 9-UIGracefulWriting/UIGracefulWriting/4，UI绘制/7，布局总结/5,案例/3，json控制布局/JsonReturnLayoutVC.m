...
@interface JsonReturnLayoutVC ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSString *jsonStr;
@property (nonatomic, copy) NSString *titleString;
@end

@implementation JsonReturnLayoutVC
...
- (void)insertWithTop
{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        self.titleString = [NSString stringWithFormat:@"展示的是%d.txts的数据",index];
